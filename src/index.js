...
bot.on("message", (msg) => {
	...
	if ((javi != null && dospuntosuve != null) || (javi != null && palabrasconcretas != null)) {
		bot.sendMessage(chatId, "@Dvdgg deficiente y pasate a Windows 10", {
		...
		bot.sendMessage(
			chatId,
			"Cock and ball torture (CBT) is a sexual activity involving application of " +
...
cron.schedule("0 0 1 * *", () => {
	...
	switch (month) {
		...
		case 5:
			bot.sendMessage(
				-1001063900471,
				"Feliz mes de junio chavalotes, que empieza el veranito"
			);
			break;
		case 6:
		...
		case 8:
			bot.sendMessage(
				-1001063900471,
				"Feliz mes de Septiembre chavalotes, la vuelta al cole"
			);
			break;
		case 9:
		...
		case 11:
			bot.sendMessage(
				-1001063900471,
				"Feliz mes de Diciembre chavalotes, abrigaos que ya hace fresco"
			);
			break;
		default:
			break;
